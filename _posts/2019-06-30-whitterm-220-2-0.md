...
<figure id="attachment_1320" aria-describedby="caption-attachment-1320" style="width: 871px" class="wp-caption aligncenter">[<img loading="lazy" class="size-full wp-image-1320" src="https://engineer.john-whittington.co.uk/wp-content/uploads/2019/06/state-mermaid.png" alt="state-mermaid" width="871" height="508" srcset="/assets/img/uploads/2019/06/state-mermaid.png 871w, /assets/img/uploads/2019/06/state-mermaid-300x175.png 300w, /assets/img/uploads/2019/06/state-mermaid-768x448.png 768w" sizes="(max-width: 871px) 100vw, 871px" />](https://engineer.john-whittington.co.uk/wp-content/uploads/2019/06/state-mermaid.png)<figcaption id="caption-attachment-1320" class="wp-caption-text">Raspberry Pi maintains I2C link with uC once booted and acts on shutdown request from button press. The LED flashing routines were the most complex part of the firmware development!</figcaption></figure>
